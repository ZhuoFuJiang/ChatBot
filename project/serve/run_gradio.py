...
from project.llm.call_llm import get_completion
from project.database.create_db import create_db_info
from project.qa_chain.Chat_QA_chain_self import Chat_QA_chain_self
from project.qa_chain.QA_chain_self import QA_chain_self
...
LLM_MODEL_DICT = {
    ...
    "zhipuai": ["chatglm_pro", "chatglm_std", "chatglm_lite", "glm-3-turbo", "glm-4v", "glm-4"]
}
...
def respond(message, chat_history, llm, history_len=3, temperature=0.1, max_tokens=2048):
    ...
    try:
        ...
        # TODO 这里后续可以加上摘要上下文，否则容易超过max_tokens
