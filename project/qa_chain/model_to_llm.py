import sys
sys.path.append("../llm")
from project.llm.wenxin_llm import Wenxin_LLM
from project.llm.spark_llm import Spark_LLM
from project.llm.zhipuai_llm import ZhipuAILLM
from langchain.chat_models import ChatOpenAI
from project.llm.call_llm import parse_llm_api_key
...
def model_to_llm(model:str=None, temperature:float=0.0, appid:str=None, api_key:str=None,Spark_api_secret:str=None,Wenxin_secret_key:str=None):
        ...
        elif model in ["chatglm_pro", "chatglm_std", "chatglm_lite", "glm-3-turbo", "glm-4v", "glm-4"]:
            if api_key == None:
